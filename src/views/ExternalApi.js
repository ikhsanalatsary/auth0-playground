...
export const ExternalApiComponent = () => {
  ...
  // getIdTokenClaims().then((data) => console.log('getIdTokenClaims ', data))
  ...
  const callProfile = async () => {
    try {
      ...
      console.log("🚀 ~ file: ExternalApi.js ~ line 98 ~ callProfile ~ __raw", __raw)
      ...
      const responseData = await response.json();
      console.log("🚀 ~ file: ExternalApi.js ~ line 102 ~ callProfile ~ responseData", responseData)

      
    } catch (error) {
      console.log("🚀 ~ file: ExternalApi.js ~ line 106 ~ callProfile ~ error", error)
